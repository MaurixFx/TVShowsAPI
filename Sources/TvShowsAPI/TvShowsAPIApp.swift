...
let logger: Logger = Logger(subsystem: "com.mfigueroa.tvshowsapi", category: "TvShowsAPI")
...
#if !SKIP
public protocol TvShowsAPIApp : App {
}

/// The entry point to the TvShowsAPI app.
/// The concrete implementation is in the TvShowsAPIApp module.
public extension TvShowsAPIApp {
    var body: some Scene {
        WindowGroup {
            RootView()
        }
